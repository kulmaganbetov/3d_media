...
const W = (file, width = 400) =>
  `https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/${encodeURIComponent(file)}&width=${width}`;
const MISSIONS = [
  { year: 1957, name: 'Спутник-1', country: 'КСРО', type: 'Жер орбитасы', description: 'Алғашқы жасанды жер серігі. Ғарыш дәуірінің басталуы.', details: 'Массасы 83.6 кг. 21 тәулік жұмыс істеді. «Бип-бип» сигналы бүкіл әлемді таңғалдырды.', image: W('Sputnik_asm.jpg') },
  { year: 1961, name: 'Восток-1', country: 'КСРО', type: 'Адам ұшырылымы', description: 'Юрий Гагарин — ғарышқа ұшқан алғашқы адам.', details: '108 минутта Жерді айналып шықты. «Поехали!» сөзі тарихқа кірді.', image: W('Yuri_Gagarin_(1961)_-_Restoration.jpg') },
  { year: 1969, name: 'Аполлон-11', country: 'АҚШ', type: 'Айға қону', description: 'Нил Армстронг пен Базз Олдрин Айға аяқ басты.', details: '«Адамзат үшін алып қадам». 21 сағат 36 минут Ай бетінде болды.', image: W('Aldrin_Apollo_11_original.jpg') },
  { year: 1971, name: 'Марс-3', country: 'КСРО', type: 'Марс миссиясы', description: 'Марс бетіне алғашқы жұмсақ қону.', details: '14.5 секунд деректер жіберді. Алғашқы Марс суреті.', image: W('Mars_3_lander_vsm.jpg') },
  { year: 1977, name: 'Вояджер 1 & 2', country: 'АҚШ', type: 'Ғарыш зерттеуі', description: 'Күн жүйесінен шыққан алғашқы аппараттар.', details: 'Вояджер-1 — Жерден ең алыс адам жасаған нысан. 24 млрд км қашықтықта.', image: W('Voyager_spacecraft_model.png') },
  { year: 1990, name: 'Хаббл телескопы', country: 'АҚШ/ESA', type: 'Телескоп', description: 'Орбиталық телескоп ғарышты зерттеу тарихын өзгертті.', details: '1.5 млн+ сурет түсірді. Deep Field суреті ғаламның тереңдігін көрсетті.', image: W('HST-SM4.jpg') },
  { year: 1991, name: 'Аубакиров ұшуы', country: 'Қазақстан/КСРО', type: 'Адам ұшырылымы', description: 'Тоқтар Аубакиров — алғашқы қазақ ғарышкер.', details: 'Союз ТМ-13 кемесімен ұшты. Мир станциясында 7 тәулік 22 сағат болды.', image: W('Toktar_Aubakirov_MIR.jpg') },
  { year: 1998, name: 'ХҒС құрылысы', country: 'Халықаралық', type: 'Ғарыш станциясы', description: 'Халықаралық ғарыш станциясының құрылысы басталды.', details: '16 ел қатысты. 2000 жылдан бері адамдар тұрақты тұрады.', image: W('International_Space_Station_after_undocking_of_STS-132.jpg') },
  { year: 2012, name: 'Curiosity', country: 'АҚШ', type: 'Марс миссиясы', description: 'Марс бетіндегі ең жетілдірілген ровер.', details: 'Марста бұрын сұйық су болғанын дәлелдеді. 2024 жылға дейін жұмыс істеді.', image: W("Curiosity_Self-Portrait_at_'Big_Sky'_Drilling_Site.jpg") },
  { year: 2021, name: 'Джеймс Уэбб', country: 'АҚШ/ESA/CSA', type: 'Телескоп', description: 'Ең қуатты ғарыш телескопы жіберілді.', details: 'Алғашқы жұлдыздар мен галактикаларды көре алады. L2 нүктесінде орналасқан.', image: W("Webb's_First_Deep_Field.jpg") },
  { year: 2024, name: 'Artemis II', country: 'АҚШ', type: 'Ай миссиясы', description: 'Адамдарды қайта Айға жіберу бағдарламасы.', details: '50+ жылдан кейін адамдар қайта Айға барады.', image: W('Orion_with_service_module.jpg') },
  { year: 2025, name: 'Starship Mars', country: 'SpaceX', type: 'Марс миссиясы', description: 'Марсқа адам жіберу жоспары.', details: 'Илон Маск адамзатты көппланеталық түр етуді мақсат етеді.', image: W('Starship_stacked_2025_(cropped).jpg') },
];
