...
const ROCKETS = [
  ...
  { name: 'Falcon 9', country: 'АҚШ', agency: 'SpaceX', year: '2010-қазіргі', height: 70, diameter: 3.7, mass: 549054, payload_leo: 22800, payload_moon: null, thrust: 7607, engines: 'Merlin 1D × 9', fuel: 'Керосин/LOX', launches: 300, success: 298, status: 'Белсенді', description: 'Әлемдегі ең сенімді және қайта пайдаланылатын ракета. 1-ші сатысы тігінен қайта қонады. Ғарыш индустриясын революциялады.', color: '#3b82f6', image: 'https://upload.wikimedia.org/wikipedia/commons/e/eb/Bangabandhu_Satellite-1_Mission_%2842025499722%29.jpg' },
  { name: 'Starship', country: 'АҚШ', agency: 'SpaceX', year: '2023-қазіргі', height: 121, diameter: 9, mass: 5000000, payload_leo: 150000, payload_moon: 100000, thrust: 74400, engines: 'Raptor × 33 (Super Heavy)', fuel: 'Метан/LOX', launches: 6, success: 3, status: 'Сынақта', description: 'Тарихтағы ең үлкен және ең қуатты ракета. Марсқа адам жіберу үшін жасалуда. Толық қайта пайдаланылатын.', color: '#8b5cf6', image: 'https://xevio.us/wp-content/uploads/2025/01/r9a8866-1-2000x1200.jpg' },
  ...
  { name: 'Long March 5', country: 'Қытай', agency: 'CNSA', year: '2016-қазіргі', height: 56.97, diameter: 5, mass: 867000, payload_leo: 25000, payload_moon: 8200, thrust: 10780, engines: 'YF-77 × 2 + 8×YF-100', fuel: 'Сутегі/LOX + Керосин', launches: 14, success: 13, status: 'Белсенді', description: 'Қытайдың ең қуатты ракетасы. Тяньгун ғарыш станциясы модульдерін және Ай миссияларын ұшырады.', color: '#dc2626', image: 'https://upload.wikimedia.org/wikipedia/commons/4/4e/%E9%95%BF%E5%BE%81%E4%BA%94%E5%8F%B7%E9%81%A5%E4%BA%8C%E7%81%AB%E7%AE%AD%E8%BD%AC%E5%9C%BA.jpg' },
];
